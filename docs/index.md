...
hero:
  name: RemixAuth
  text: Authentication for Remix 3!
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/zitadel/remix-auth

features:
  - title: OAuth
    details: Effortlessly connect your Remix 3 application with Google, GitHub, Azure and countless others.
  ...
  - title: Made for Remix 3
    details: Deep integrations with the Remix 3 framework.
